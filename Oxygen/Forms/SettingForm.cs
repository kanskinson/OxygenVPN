...
namespace OxygenVPN.Forms
{
    public partial class SettingForm : Form
    {
        ...
        private void ControlButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (taskIsExists)
                    folder.DeleteTask("Oxygen Startup", 0);

                var task = scheduler.NewTask(0);
                task.RegistrationInfo.Author = "Oxygen";
                task.RegistrationInfo.Description = "Oxygen run at startup.";
                ...
                folder.RegisterTaskDefinition("Oxygen Startup", task, (int) _TASK_CREATION.TASK_CREATE, null, null,
