...
namespace OxygenVPN.Controllers {
    public class TUNTAPController : ModeController {
        ...
        private bool SetupRouteTable() {
            Logging.Info("Collecting routing table rules");
            Global.MainForm.StatusText(i18N.Translate("SetupBypass"));

            Logging.Info("Detour>>Global IP");
            _directIPs.AddRange(Global.Settings.BypassIPs.Select(IPNetwork.Parse));

            Logging.Info("Detour>>Server IP");
            ...
            case 1:
                ...
                if (Global.Settings.STUN_Server == "stun.stunprotocol.org")
                    try {
                        Logging.Info("Proxy>>STUN Server IP");
                        ...
                        Logging.Info("NAT type test domain name resolution failed and will not be added to the proxy list");
                    }

                if (Global.Settings.TUNTAP.ProxyDNS) {
                    Logging.Info("Proxy>>Custom DNS");
            ...
            case 2:
                ...
                if (_savedMode.BypassChina) {
                    Logging.Info("Detour>>Chinese IP");
            ...
            Logging.Info("Set routing rules");
